...
const About = () => {
    ...
    const aboutMeText = "I am Toufik Gouri, an experienced Full-Stack Developer based in Bhiwandi(Thane), India. I am skilled in JavaScript, HTML, CSS, and backend technologies. Proficient in ReactJS, Redux, NodeJs, ExpressJs, and MongoDB, with a proven track record of developing responsive and dynamic web applications. Strong problem-solving abilities and a commitment to delivering high-quality, user-friendly solutions."
            ...
            <section className="flex max-md:flex-col items-center md:justify-center my-10  max-md:mt-10">
                ...
                <div className="sectionRight w-full p-4 md:w-2/5">
                    <BlurIn
                        duration={0.5}
                        word={aboutMeText}
                        className="md:text-2xl max-md:mx-2 text-justify text-black dark:text-white"
                    />
