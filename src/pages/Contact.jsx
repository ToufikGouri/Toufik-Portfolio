        ...
        <>
            ...
            <BlurFade delay={0.25} inView>
                ...
                <div className='flex max-md:flex-col-reverse justify-center items-center'>
                    {/* Socials */}
                    <div className='flex'>
                        <p className='md:text-xl text-neutral-600/70 dark:text-neutral-400/70 me-2'>Find me on:</p>
                        <div className='dark:invert w-40 flex justify-around items-center'>
                            <a href='https://github.com/ToufikGouri' target='_blank' className="size-6 md:size-8 hover:scale-105">{socialIcon.github} </a>
                            <a href='https://www.linkedin.com/in/toufikgouri' target='_blank' className="size-6 md:size-8 hover:scale-105">{socialIcon.linkedin} </a>
                            <a href='https://www.instagram.com/itz_mtg_' target='_blank' className="size-6 md:size-8 hover:scale-105">{socialIcon.instagram} </a>
                        </div>
                    </div>
